        ...
        return (
                                    <div className="card led-stats-card">
                                        ...
                                        <div className="card-footer">
                                            <div className="row">
                                                <div className="col-md-4">
                                                    <span>Illuminatioff Distance  <br/>   (in <i>cm</i>)</span>
                                                </div>
                                                <div className="col-md-6">
                                                    <Slider min={0} max={19}
                                                            value={this.props.led_panel_dac5578[this.props.prefix+'_illuminatioff_distance']}
                                                            handle={handle}
                                                            onChange={this.OnLEDPanelChange.bind(this, 'led_panel_dac5578', this.props.prefix+'_illuminatioff_distance')}/>
                                                </div>
                                                <div className="col-md-2">
                                                   {this.props.led_panel_dac5578[this.props.prefix+'_illuminatioff_distance']}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
